...
import org.firstinspires.ftc.teamcode.subsystems.Mechanism;
...
public class Pivot extends Mechanism {
    ...
    //Physical Constants
    public static double SLIDE_TICKS_PER_REV = 384.5;
    public static double PIVOT_TICKS_PER_REV = 5281.1;
    public static double SLIDE_PULLEY_RADIUS = 0.701771654; //in
